...
class RestaurantHybridModel:
    ...
    def selectTopRestaurants(self, topic_pred,restaurant_reviews,lda_model ):
        ...
        for _, row in restaurant_reviews.iterrows():
            ...
            lda_scores = [temp[0][1],temp[1][1],temp[2][1],temp[3][1],temp[4][1],temp[5][1],temp[6][1],temp[7][1],temp[8][1],temp[9][1]]
            # Normalize the LDA scores to sum up to 1
            lda_scores /= sum(lda_scores)
            # Calculate the weighted score
            weighted_score = np.dot(lda_scores, [ps, ps, ps, ps, ps, ps, ps, ps, ps, ps]) - np.dot(lda_scores, [ns, ns, ns, ns, ns, ns, ns, ns, ns, ns])
    ...
    def train(self, preferred_cuisine=None, preferred_city=None):
        ...
        recommendations_cf = pd.DataFrame(user_predictions, columns=['rating', 'restaurant_id']) # dataframe for orginal data
        
        recommendations_cf = recommendations_cf.merge(filtered_restaurants, on='restaurant_id') # dataframe for predictions and meging it
...
if __name__ == "__main__":
    ...
    recommendation_system = RestaurantHybridModel(['1RWUScIcfDfj7artDU1xfzR3biAzLl6pe', '178FeiC8Rrt0qzqlmYSYDoqaVIPNNmjtZ', '1CVGRr9EzCy-jAD82SJMrjrSTAk7lXOak', '1oDNBSn90Mf2ao74vejvmITLZ7y5OrveV','1RoZqZCZ9h4G-XL89Zz2qZhZceYLj1QWe', '10ndnl89HiMXY8ntYqCJPdsAp8IYMFRr6', '1XPPd7bFY-PM5DzvsHsR3hxINeg9gELTq', '1D_5Yg6K0SDRRopHEVyEkV7BW15AJRuZX', '1Wz8irmxT3869APcOO21XuJR4cDSQkFJY', '1Q2jr2BJDKxmLZ-mr2utF09QgtOh79BrB', '1GTibrww-DO8uHGvTLzMUXdSDqe8qSRSI'])
